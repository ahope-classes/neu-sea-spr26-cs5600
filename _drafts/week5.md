...
* step 1: the concept of *critical sections*
    ...
    * Regard accesses of shared variables (for example, "count" in the bounded buffer example) as being in a _critical section_
...
- interesting question: are there zombie threads? [No]  why not?
...
* Question: by the way, why aren't we worried about *processes* trashing each other's memory?
